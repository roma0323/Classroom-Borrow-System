...
CREATE TABLE IF NOT EXISTS `Classroon_Equipment_Booking_System`.`Booking` (
  ...
  INDEX `id_borrow_idx` (`id_borrow` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Classroon_Equipment_Booking_System`.`Borrow_Equipment` (
  ...
  INDEX `idBorrow_idx` (`id_borrow` ASC) VISIBLE,
  INDEX `idEquipment_idx` (`id_equipment` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Data for table `Classroon_Equipment_Booking_System`.`Member`
-- -----------------------------------------------------
START TRANSACTION;
USE `Classroon_Equipment_Booking_System`;
INSERT INTO `Classroon_Equipment_Booking_System`.`Member` (`id_member`, `name`, `email`, `identity`, `password`) VALUES (1, 'admin', 'admin@gmail.com', 'ROLE_ADMIN', '$2a$10$Fy8UNZq6q4rt6syd0pXHqe08nrlmGrp9Gv7nfn3FthcqSo0Ks9AuK');
INSERT INTO `Classroon_Equipment_Booking_System`.`Member` (`id_member`, `name`, `email`, `identity`, `password`) VALUES (2, 'worker', 'worker@gmail.com', 'ROLE_WORKER', '$2a$10$9DcMwdgWv4JMZhM1ieueke50Ven8fvphDo5o/pLxoj4KD54YIGWXm');
